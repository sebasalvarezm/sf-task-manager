...
-- ============================================================
-- Table 10: Weekly Outreach
-- ============================================================
-- Replaces the weekly Excel tracker. RCE rows arrive from Open Tasks, E1 rows
-- arrive from Re-Contact, and either type can be added manually by exact
-- Salesforce account name. One account/type can appear only once per week.
