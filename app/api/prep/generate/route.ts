...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // Step 3: Build the prompt — anchored on the target company (see the long
    // comment in lib/jobs/prep-runner.ts for the rationale).
    const targetCompany = accountName || siteUrl || "Unknown";
